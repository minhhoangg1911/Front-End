const Blogs = () => {
    return (
        <div className="container-xl mt-[50px]">
            <div className="">
            ...
            <div className="mt-[20px] mb-[50px] cursor-pointer group">
                <a className="border border-[rgba(0,0,0,0.1)] rounded-[10px] flex overflow-hidden max-md:flex-col ">
                    <div className="overflow-hidden">
                        <img className=" w-full object-cover min-h-[418px] max-h-[418px] group-hover:scale-105 duration-300 " src='https://cdn.prod.website-files.com/665ad48cef8cc551376f7777/665d4bc0039993d2b07c7e39_blog-main-01-p-500.jpg' />
                    </div>
                    <div className="flex flex-col  gap-y-[80px] items-start w-full justify-between max-w-[50%] p-[60px] max-md:max-w-[100%]">
                        <div>
                            <div>
                                <div className="mb-[20px]">Tricks for packing light and maximizing space in your luggage</div>
                                <div className="flex gap-x-2 text-[14px] leading-[150%]">
                                    <div>Travel Tips</div>
                                    <div className="bg-[rgba(0,0,0,0.1)] w-[1px] h-auto"></div>
                                    <div>Jun 3, 2024</div>
                                </div>

                            </div>
                        </div>
                        <div className="flex gap-x-2 items-center leading-[120%] text-[14px] ">
                            <div>Read Articles</div>
                            <div className="group-hover:translate-y-[-4px] group-hover:translate-x-[4px] duration-500 ">
                                <img src='https://cdn.prod.website-files.com/660feff9e6770765774f4a4f/66599c3a19bedbe57ff6639f_button-arrow.svg' />
                            </div>
                        </div>
                    </div>
                </a>
