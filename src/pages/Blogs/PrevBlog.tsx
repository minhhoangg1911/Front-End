        ...
        <div>
            <div className="container-xl mt-[50px]">
                ...
                <div className="mt-[20px] mb-[50px] cursor-pointer group">
                    <a className="border border-[rgba(0,0,0,0.1)] rounded-[10px] flex overflow-hidden ">
                        ...
                        <div className="flex flex-col  gap-y-[80px] items-start w-full justify-between max-w-[50%] p-[60px]">
                            <div>
                                <div>
